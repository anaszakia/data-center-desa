...
Route::middleware(['auth', 'log.sensitive'])->group(function () {
    ...
    Route::get('/penduduk', [\App\Http\Controllers\PendudukController::class, 'index'])
        ->middleware('permission:view penduduk')
        ->name('penduduk.index');
    ...
    Route::post('/penduduk', [\App\Http\Controllers\PendudukController::class, 'store'])
        ->middleware('permission:create penduduk')
        ->name('penduduk.store');
    Route::get('/penduduk/{penduduk}', [\App\Http\Controllers\PendudukController::class, 'show'])
        ->middleware('permission:view penduduk')
        ->name('penduduk.show');
    Route::get('/penduduk/{penduduk}/edit', [\App\Http\Controllers\PendudukController::class, 'edit'])
        ->middleware('permission:edit penduduk')
        ->name('penduduk.edit');
    Route::put('/penduduk/{penduduk}', [\App\Http\Controllers\PendudukController::class, 'update'])
        ->middleware('permission:edit penduduk')
        ->name('penduduk.update');
    Route::delete('/penduduk/{penduduk}', [\App\Http\Controllers\PendudukController::class, 'destroy'])

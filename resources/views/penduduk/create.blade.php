                ...
                <div x-show="tab === 3">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="pekerjaan" id="pekerjaan" value="{{ old('pekerjaan') }}" maxlength="100" class="w-full px-4 py-2 border border-gray-200 rounded-lg">
                        ...
                        <div>
                            ...
                            <select name="status_dalam_keluarga" id="status_dalam_keluarga" class="w-full px-4 py-2 border border-gray-200 rounded-lg">
                                ...
                                <option value="Lain-lain" {{ old('status_dalam_keluarga') == 'Lain-lain' ? 'selected' : '' }}>Lain-lain</option>
                            </select>
                        ...
                        <div class="md:col-span-2 flex items-center mb-4">
                            ...
                            <input type="checkbox" name="status" id="status" value="1" class="mr-2" checked>

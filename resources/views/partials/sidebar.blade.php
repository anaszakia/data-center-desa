...
<div id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-white transform -translate-x-full lg:translate-x-0 lg:static lg:z-auto flex flex-col border-r border-gray-200 transition-transform duration-200">
    ...
    <nav class="flex-1 px-3 py-4 overflow-y-auto">
        <ul class="space-y-1">
            ...
            @can('edit profile')
                <li>
                    <a href="{{ route('penduduk.index') }}" class="flex items-center px-3 py-2 text-sm text-gray-700 rounded hover:bg-gray-100 transition-colors {{ request()->routeIs('profile.*') ? 'bg-gray-900 text-white hover:bg-gray-900' : '' }}">
